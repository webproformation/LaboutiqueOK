...
export function ScratchCardGame({ game, onClose, onWin }: ScratchCardGameProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div
        className="relative bg-gradient-to-br from-[#1a1a1a] via-[#2a2a2a] to-[#1a1a1a] rounded-2xl p-8 max-w-2xl w-full border-2 border-[#d4af37] shadow-2xl"
        style={{
          boxShadow: '0 0 30px rgba(212, 175, 55, 0.3)',
        }}
      >
        ...
        <div className="text-center space-y-6">
          ...
          <div className="relative">
            <div
              className="w-full aspect-[4/3] rounded-xl flex items-center justify-center text-center p-8 relative overflow-hidden"
            ...
            >
              {!isRevealed ? (
                ...
                <div className="animate-bounce-in space-y-4">
                  <Gift className="h-20 w-20 text-[#d4af37] mx-auto animate-pulse" />
                  <div className="text-white">
                    <h3 className="text-3xl font-bold mb-2">Félicitations!</h3>
                    <p className="text-xl mb-2">Vous avez gagné :</p>
                    <div className="bg-white/10 rounded-lg p-4 border-2 border-[#d4af37]">
                      <p className="text-2xl font-bold text-[#d4af37]">{prize}</p>
                    </div>
