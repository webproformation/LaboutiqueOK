    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center space-y-6">
          ...
          {prize && !spinning && (
            <div className="animate-bounce-in space-y-4 p-6 bg-gradient-to-br from-[#d4af37]/20 to-transparent rounded-xl border border-[#d4af37]">
              <Trophy className="h-16 w-16 text-[#d4af37] mx-auto animate-pulse" />
